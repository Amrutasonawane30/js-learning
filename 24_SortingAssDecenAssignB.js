...
console.log("======================= Step 1 =========================");
console.log(`Sorting array in decending order of employee id's`);
...
console.log("\n==================== Step 2 =========================");
console.log(`Sorting array in ascending order of employee department`);
arrayEmployees.sort( (p1,p2) =>{
...
console.log("\n==================== Step 3 =========================");
console.log(`Sorting array in decending order of employee salary`);
arrayEmployees.sort( (p1,p2) =>{
